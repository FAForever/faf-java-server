...
public class UniqueIdServiceTest {
  ...
  public void verifyCreatesNewHardwareInformation() throws Exception {
    ...
    Mockito.verify(hardwareInformationRepository).save(captor.capture());
    ...
    assertThat(hardwareInformation.getMemSerialNumber(), is(""));
    assertThat(hardwareInformation.getName(), is(""));
    assertThat(hardwareInformation.getProcessorId(), is(""));
    assertThat(hardwareInformation.getSerialNumber(), is(""));
    assertThat(hardwareInformation.getSmbiosbiosVersion(), is(""));
    assertThat(hardwareInformation.getUuid(), is(""));
    assertThat(hardwareInformation.getVolumeSerialNumber(), is(""));
    assertThat(hardwareInformation.getHash(), is(""));
  }
  ...
  public void verifyAddsPlayerToExistingHardwareInformation() throws Exception {
    ...
    Mockito.verify(hardwareInformationRepository).save(hardwareInformation);
    assertThat(hardwareInformation.getPlayers(), hasSize(1));
    assertThat(hardwareInformation.getPlayers().iterator().next(), is(player));
  }
