...
public enum Unit {
  ...
  public static final Unit[] ACUS = new Unit[]{
    Unit.AEON_ACU,
    Unit.CYBRAN_ACU,
    Unit.UEF_ACU,
    Unit.SERAPHIM_ACU
  };
  public static final Unit[] ASFS = new Unit[]{
    Unit.CORONA,
    Unit.GEMINI,
    Unit.WASP,
    Unit.IAZYNE
  };
  public static final Unit[] SACUS = new Unit[]{
    Unit.AEON_SACU,
    Unit.CYBRAN_SACU,
    Unit.UEF_SACU,
    Unit.SERAPHIM_SACU
  };
  public static final Unit[] EXPERIMENTALS = new Unit[]{
    Unit.YOLONA_OSS,
    Unit.PARAGON,
    Unit.ATLANTIS,
    Unit.TEMPEST,
  ...
  public static final Unit[] TRANSPORTS = new Unit[]{
    Unit.CHARIOT,
    Unit.ALUMINAR,
    Unit.SKYHOOK,
    Unit.DRAGON_FLY,
  ...
  public static final Unit[] ENGINEERS = new Unit[]{
