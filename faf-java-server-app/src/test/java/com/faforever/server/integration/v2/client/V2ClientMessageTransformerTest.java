...
import com.faforever.server.integration.v2.client.ArmyOutcomeClientMessage.Outcome;
...
public class V2ClientMessageTransformerTest {
  ...
  public void armyOutcome() throws Exception {
    ...
    assertThat(result, is(new ArmyOutcomeReport(1, com.faforever.server.game.Outcome.DEFEAT, -1)));
  }
  ...
  public void searchMatch() throws Exception {
    ...
    assertThat(result, is(new MatchMakerSearchRequest(com.faforever.server.game.Faction.UEF, "ladder1v1")));
  }
